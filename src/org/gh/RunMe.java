...
public class RunMe{
    ...
    public static void main(String args[]){
        ...
        //print details of friend
        System.out.println("Print with name from person and age from friend");
        System.out.println(objFriend.getName() + "-" + objFriend.getAge());
        ...
        System.out.println(objFriend.printMe());
