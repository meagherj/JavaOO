...
public class RunMe{
    ...
    public static void main(String args[]){
        ...
        System.out.println("Creating a new student, character, and Teacher");
        Student objStudent = new Student("Student 1", "GradeA");
        Teacher objTeacher = new Teacher("Teacher 1", "Class#1, Class#2");
        Character objCharacter = new Character("Character 1", "Action1");
        ...
        System.out.println("Print with name (from person) and Classes (from Teacher)");
        System.out.println(objCharacter.getAction() + " - " + objCharacter.getName());
        ...
        System.out.println(objCharacter.printMe());
